...
| File | Content | Status |
|------|---------|--------|
| `core-infrastructure.kicad_sch` | Core infrastructure (battery → switch → buck → 5V bus, ESP32-S3, PCA9685) | Complete (v1.5, ERC clean) |
| `blaster.kicad_sch` | Blaster zone — 5 MOSFET channels (Ch 0–4); Ch 5 (heatsink front) not yet added | Updated, ERC not re-run |
