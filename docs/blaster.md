...
| **SOT-23 breakout boards** | SOT-23 to DIP adapter breakout boards | 5–10 | Amazon | Arrived | For breadboard prototyping — solder IRLML6344 to SMD pads, solder male headers, plugs into breadboard. One per blaster channel for prototype validation. |